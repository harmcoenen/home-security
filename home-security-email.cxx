...
#define FROM    "<from@example.org>"
#define TO      "<to@example.org>"
#define CC      "<cc@example.org>"

static const char *headers_text[] = {
  "Date: Mon, 16 Dec 2019 14:08:43 +0100",
  "To: " TO,
...
int send_email(void)
{
  ...
  if(curl) {
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "smtp://smtp.example.org");
    ...
    part = curl_mime_addpart(mime);
    curl_mime_filedata(part, "/home/nano/github/home-security/home-security-email.cxx");
